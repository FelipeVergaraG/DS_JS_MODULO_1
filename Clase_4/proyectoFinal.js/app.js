...
while (true) {
  ...
  const opcion = prompt("Elige una opción: ").toLowerCase();
  if (opcion === "salir") {
  ...
  switch (opcion) {
    case "1": {
      ...
      const agregada = tareas.agregarTarea(lista, titulo, prioridad);
      if (agregada === true) {
        console.log("Tarea agregada.");
      } else {
        console.log("Prioridad no válida. Usa alta, media o baja.");
      }
      break;
    }
    case "2":
